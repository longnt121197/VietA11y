...
Report abusive, harassing, or otherwise unacceptable behavior confidentially to
the project maintainers through the repository's
[private reporting form](https://github.com/longnt121197/vieta11y/security/advisories/new).
Begin the report title with `[Code of Conduct]`. Reports will be reviewed and
investigated promptly and fairly. Maintainers will respect the privacy and
security of the reporter.

## Enforcement Guidelines

Community leaders will follow these Community Impact Guidelines when determining
...
version 2.1, available at the [official version 2.1 page][version]. Community
Impact Guidelines were inspired by [Mozilla's code of conduct enforcement
ladder][mozilla].
